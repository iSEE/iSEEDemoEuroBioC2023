...
sce <- embedPathwaysResults(fgseaRes, sce, name = "IFNgTRUE.SL1344TRUE.limma.fgsea", 
                            class = "fgsea", pathwayType = "GO", pathwaysList = pathways, 
...
For a more extensive description of the different parts of the interface, we refer to the [overview](overview.html) vignette.
